...
#### anova pour tester les effets aléatoires
 = sm.datasets.longley.load(as_pandas=False)
...
### bootstrap paramétrique: pour tester les effets aleatoires.

nboot= 1000
n_size = int(len(Estuaries) * 0.60)
# run bootstrap
stats = list()
for i in range(nboot):
	# prepare train and test sets
